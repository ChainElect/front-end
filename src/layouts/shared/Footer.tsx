    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          {/* Community Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent">
              {t("footer.community")}
            </h3>
            <div className="flex space-x-4">
              {[
                ...
                <a
                  key={index}
                  href={social.link}
                  className="p-2 rounded-lg transition-all hover:bg-secondary/10"
                  style={{ color: text }}
                >
          ...
          <div className="space-y-6">
            <ConnectButton
              ...
              fullWidth
            />
            <ThemeToggle className="w-full justify-center border hover:border-secondary" />
          </div>
        </div>
          ...
          <div className="flex space-x-6">
            {["terms", "privacy", "docs"].map((item) => (
              <a
                key={item}
                href={`/${item}`}
                className="text-sm transition-all hover:text-secondary"
                style={{ color: text }}
              >
                {t(`footer.${item}`)}
              </a>
